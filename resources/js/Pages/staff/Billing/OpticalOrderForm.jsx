        ...
        <Card className="rounded-2xl shadow-sm">
          <CardContent className="p-6 space-y-4">
            ...
            {frames.map((frame, index) => (
              <div key={index} className="grid md:grid-cols-3 gap-4 border p-4 rounded-xl items-end">
                ...
                <div>
                  ...
                  <Input
                    value={frame.name}
                    onChange={(e) =>
                      handleFrameChange(index, "name", e.target.value)
                    }
                  />
                </div>
        ...
        <Card className="rounded-2xl shadow-sm">
          <CardContent className="p-6 space-y-6">
            ...
            {lenses.map((lens, index) => (
              <div key={index} className="border rounded-xl p-5 space-y-4 relative">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <Input
                        ...
                        onChange={(e) =>
                          handleLensChange(index, "right", "sph", e.target.value)
                        }
                      />
                      <Input
                        placeholder="AXIS"
                        ...
                        onChange={(e) =>
                          handleLensChange(index, "right", "axis", e.target.value)
                        }
                      />
                      <Input
                        placeholder="VA"
                        value={lens.right.va}
                        onChange={(e) =>
                          handleLensChange(index, "right", "va", e.target.value)
                        }
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <Input
                        ...
                        value={lens.left.sph}
                        onChange={(e) =>
                          handleLensChange(index, "left", "sph", e.target.value)
                        }
                      />
                      <Input
                        placeholder="AXIS"
                        ...
                        onChange={(e) =>
                          handleLensChange(index, "left", "axis", e.target.value)
                        }
                      />
                      <Input
                        placeholder="VA"
                        value={lens.left.va}
                        onChange={(e) =>
                          handleLensChange(index, "left", "va", e.target.value)
                        }
                      />
                    </div>
                  </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={lens.lensType}
                      onChange={(e) =>
                        handleLensChange(index, "lensType", null, e.target.value)
                      }
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={lens.price}
                      onChange={(e) =>
                        handleLensChange(index, "price", null, e.target.value)
                      }
                    />
                  </div>
